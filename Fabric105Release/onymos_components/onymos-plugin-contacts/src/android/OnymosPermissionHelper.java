 ...
 *	Filename : OnymosPermissionHelper.java
 *
 ...
 */
public class OnymosPermissionHelper {
    private static final String LOG_TAG = "OnymosPermissionHelper";
    ...
    public static void requestPermission(CordovaPlugin plugin, int requestCode, String permission) {
        OnymosPermissionHelper.requestPermissions(plugin, requestCode, new String[] {permission});
    }
